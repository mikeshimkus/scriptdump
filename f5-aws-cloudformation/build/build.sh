...
## Supported - prod stacks - No longer generated
...
## Marketplace
# python master_template.py -s existing -n 2 -l hourly -H across-az -M Good25Mbps -T f5-existing-stack-across-az-cluster-Good25Mbps-2nic-bigip.template > ../supported/failover/across-net/via-api/2nic/existing-stack/marketplace/f5-existing-stack-across-az-cluster-Good25Mbps-2nic-bigip.template
# python master_template.py -s existing -n 2 -l hourly -H across-az -M Good200Mbps -T f5-existing-stack-across-az-cluster-Good200Mbps-2nic-bigip.template > ../supported/failover/across-net/via-api/2nic/existing-stack/marketplace/f5-existing-stack-across-az-cluster-Good200Mbps-2nic-bigip.template
# python master_template.py -s existing -n 2 -l hourly -H across-az -M Good1000Mbps -T f5-existing-stack-across-az-cluster-Good1000Mbps-2nic-bigip.template > ../supported/failover/across-net/via-api/2nic/existing-stack/marketplace/f5-existing-stack-across-az-cluster-Good1000Mbps-2nic-bigip.template
# python master_template.py -s existing -n 2 -l hourly -H across-az -M Good5000Mbps -T f5-existing-stack-across-az-cluster-Good5000Mbps-2nic-bigip.template > ../supported/failover/across-net/via-api/2nic/existing-stack/marketplace/f5-existing-stack-across-az-cluster-Good5000Mbps-2nic-bigip.template
# python master_template.py -s existing -n 2 -l hourly -H across-az -M Better25Mbps -T f5-existing-stack-across-az-cluster-Better25Mbps-2nic-bigip.template > ../supported/failover/across-net/via-api/2nic/existing-stack/marketplace/f5-existing-stack-across-az-cluster-Better25Mbps-2nic-bigip.template
# python master_template.py -s existing -n 2 -l hourly -H across-az -M Better200Mbps -T f5-existing-stack-across-az-cluster-Better200Mbps-2nic-bigip.template > ../supported/failover/across-net/via-api/2nic/existing-stack/marketplace/f5-existing-stack-across-az-cluster-Better200Mbps-2nic-bigip.template
# python master_template.py -s existing -n 2 -l hourly -H across-az -M Better1000Mbps -T f5-existing-stack-across-az-cluster-Better1000Mbps-2nic-bigip.template > ../supported/failover/across-net/via-api/2nic/existing-stack/marketplace/f5-existing-stack-across-az-cluster-Better1000Mbps-2nic-bigip.template
# python master_template.py -s existing -n 2 -l hourly -H across-az -M Better5000Mbps -T f5-existing-stack-across-az-cluster-Better5000Mbps-2nic-bigip.template > ../supported/failover/across-net/via-api/2nic/existing-stack/marketplace/f5-existing-stack-across-az-cluster-Better5000Mbps-2nic-bigip.template
# python master_template.py -s existing -n 2 -l hourly -H across-az -M Best25Mbps -T f5-existing-stack-across-az-cluster-Best25Mbps-2nic-bigip.template > ../supported/failover/across-net/via-api/2nic/existing-stack/marketplace/f5-existing-stack-across-az-cluster-Best25Mbps-2nic-bigip.template
# python master_template.py -s existing -n 2 -l hourly -H across-az -M Best200Mbps -T f5-existing-stack-across-az-cluster-Best200Mbps-2nic-bigip.template > ../supported/failover/across-net/via-api/2nic/existing-stack/marketplace/f5-existing-stack-across-az-cluster-Best200Mbps-2nic-bigip.template
# python master_template.py -s existing -n 2 -l hourly -H across-az -M Best1000Mbps -T f5-existing-stack-across-az-cluster-Best1000Mbps-2nic-bigip.template > ../supported/failover/across-net/via-api/2nic/existing-stack/marketplace/f5-existing-stack-across-az-cluster-Best1000Mbps-2nic-bigip.template
# python master_template.py -s existing -n 2 -l hourly -H across-az -M Best5000Mbps -T f5-existing-stack-across-az-cluster-Best5000Mbps-2nic-bigip.template > ../supported/failover/across-net/via-api/2nic/existing-stack/marketplace/f5-existing-stack-across-az-cluster-Best5000Mbps-2nic-bigip.template
