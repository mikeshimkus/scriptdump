...
def add_resources_autoscale(ha_type,t,restrictedSrcAddress,managementGuiPort,restrictedSrcAddressApp,Vpc,cloudlib_url,cloudlib_aws_url,as3_url,cloud_logger_url,discovery_url,lines,comment_out,loglevel,components,license_type,BIGIP_VERSION,template_name,version):
    ...
    if "hourly" in license_type and "bigiq" in license_type:
        launch_config_metadata_byol = create_launch_config_metadata(ha_type,cloudlib_url,cloudlib_aws_url,as3_url,cloud_logger_url,discovery_url,get_lines,cloudlibs_sh,waitthenrun_sh,get_nameserver,loglevel,components,{"bigiq":True},BIGIP_VERSION,template_name,version)
        launch_config_metadata = create_launch_config_metadata(ha_type,cloudlib_url,cloudlib_aws_url,as3_url,cloud_logger_url,discovery_url,get_lines,cloudlibs_sh,waitthenrun_sh,get_nameserver,loglevel,components,{"hourly":True},BIGIP_VERSION,template_name,version)
    else:
        launch_config_metadata = create_launch_config_metadata(ha_type,cloudlib_url,cloudlib_aws_url,as3_url,cloud_logger_url,discovery_url,get_lines,cloudlibs_sh,waitthenrun_sh,get_nameserver,loglevel,components,license_type,BIGIP_VERSION,template_name,version)
...
### Cloudlib and iApp URL
    ...
    ### BEGIN RESOURCES
    if ha_type == "autoscale":
        add_resources_autoscale(ha_type,t,restrictedSrcAddress,managementGuiPort,restrictedSrcAddressApp,Vpc,cloudlib_url,as3_url,cloudlib_aws_url,cloud_logger_url,discovery_url,lines,comment_out,loglevel,components,license_type,BIGIP_VERSION,template_name,version)
    else:
        if network == True:
